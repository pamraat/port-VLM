function [a,b,nor]=infcoeffgr(x,y,z,aoa)
n=size(x,1)-1;
m=(size(x,2)-1)/2;
for i=1:n
for j=1:2*m
...
for j=1:2*m
    ...
    for l=1:2*m
        ...
        v=v+vortring(h(k+1,1,l,g1),h(k+1,2,l,g1),h(k+1,3,l,g1),h(k+1,1,l,g1)+const,h(k+1,2,l,g1),h(k+1,3,l,g1)+const*tan(-aoa),h(k+1,1,l+1,g1)+const,h(k+1,2,l+1),h(k+1,3,l+1,g1)+const*tan(-aoa),h(k+1,1,l+1,g1),h(k+1,2,l+1,g1),h(k+1,3,l+1,g1),coll(i,1,j,g),coll(i,2,j,g),coll(i,3,j,g));
        v=v+v1;
        vw=vw+vw1;
        end
        end
