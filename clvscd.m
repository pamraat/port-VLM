...
aoa(v)=aoa(v)*pi/180;
vinf=[vinf*cos(aoa(v)) 0 vinf*sin(aoa(v))];
...
n=5;        %initializing variable for chordwise points
m=8;        %initializing variable for spanwise points
...
[a,b,a1,b1,nor]=infcoeffgr1(x,y,z,aoa(v));
k=size(a,1);
...
%fprintf('Lift is %f\n', L);
cl(v)=L/(0.5*rho*norm(vinf)^2*(areaquad(x(1,1),y(1,1),z(1,1),x(n+1,1),y(n+1,1),z(n+1,1),x(1,m+1),y(1,m+1),z(1,m+1),x(n+1,m+1),y(n+1,m+1),z(n+1,m+1))+areaquad(x(1,m+1),y(1,m+1),z(1,m+1),x(n+1,m+1),y(n+1,m+1),z(n+1,m+1),x(1,2*m+1),y(1,2*m+1),z(1,2*m+1),x(n+1,2*m+1),y(n+1,2*m+1),z(n+1,2*m+1))));
%fprintf('Cl is %f\n', cl);
...
%fprintf('Drag is %f\n', D);
cd(v)=D/(0.5*rho*norm(vinf)^2*(areaquad(x(1,1),y(1,1),z(1,1),x(n+1,1),y(n+1,1),z(n+1,1),x(1,m+1),y(1,m+1),z(1,m+1),x(n+1,m+1),y(n+1,m+1),z(n+1,m+1))+areaquad(x(1,m+1),y(1,m+1),z(1,m+1),x(n+1,m+1),y(n+1,m+1),z(n+1,m+1),x(1,2*m+1),y(1,2*m+1),z(1,2*m+1),x(n+1,2*m+1),y(n+1,2*m+1),z(n+1,2*m+1))));
%fprintf('Cd is %f\n', cd);
